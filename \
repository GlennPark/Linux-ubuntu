...
int main(int argc, char** argv) 
{
	...
	int paddingSize = (((bmpInfoHeader.biWidth + bmpInfoHeader.biHeight + 2)*2)*elemSize);
    /* 이미지의 해상도(넓이 × 깊이) */
	...
	padding = (ubyte*)malloc(((sizeof(ubyte)*imageSize+paddingSize)*2)*elemSize);	
...
//							 {-1, -1, -1} };
	...
	memset(padding, 0, sizeof(ubyte)*imageSize + paddingSize);
